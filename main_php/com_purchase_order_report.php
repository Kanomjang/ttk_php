<?php
include("../lib_org.php");
$title_head_html = "พิมพ์ใบขอซื้อ/ใบสั่งซื้อ";
$position_active = '13';
...
function check_no_order($date_delivery)
{
  ...
  $check_no_order = 0;
  $connect = mysqli_connect($host, $user, $passwd, $database) or die("not connect database");
  $sql_query = "SELECT no_order from com_purchase_request WHERE com_purchase_request.date_delivery='$date_delivery' ORDER BY id_cpr desc LIMIT 0,1";
...
function com_purchase_request()
{
  ...
  $a = 0;
  $connect = mysqli_connect($host, $user, $passwd, $database) or die("not connect database");
  $sql_query = "SELECT com_purchase_request.id_cpr,com_purchase_request.date_delivery,com_purchase_request.date_use,com_purchase_request.title_cpr,com_purchase_request.id_dept,com_purchase_request.id_use FROM com_purchase_request WHERE com_purchase_request.approve ='1'";
  $shows = mysqli_query($connect, $sql_query);
  while ($row = mysqli_fetch_array($shows)) {
    $id_cpr = $row["id_cpr"];
    ...
    $print[$a] = "
		<TR>
            ...
            <TD><A href='../../tcpdf/examples/com_pdf_purchase_request_report.php?com_purchase_request_report=$encode_id_cpr'  class=\"btn btn-info\" role=\"button\">พิมพ์ใบขอซื้อ(PR)</A></TD>
            <TD><A href='../../tcpdf/examples/com_pdf_purchase_order_report.php?com_purchase_request_report=$encode_id_cpr'  class=\"btn btn-info\" role=\"button\">พิมพ์ใบขอซื้อ(PO)</A></TD>
		</TR>";
    $a++;
  }
  mysqli_close($connect);
          ...
          <div class=\"wrapper\">
              ...
              <div class=\"content-wrapper\">
                  ...
                  <section class=\"content-header\">
                      <h1>
                          พิมพ์ใบขอซื้อ/ใบสั่งซื้อ
                          <small>Version 1.0</small>
                      </h1>
                      <ol class=\"breadcrumb\">
                          <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Home</a></li>
                          <li class=\"active\">พิมพ์ใบขอซื้อ/ใบสั่งซื้อ</li>
                      </ol>
                  </section>
                  <!-- Info boxes -->
                  <div class=\"row\">
                          ...
                          <div class=\"col-xs-12\">
                              <div class=\"box\">
                                  <div class=\"box-header\">
                                      <h3 class=\"box-title\">พิมพ์ใบขอซื้อ/ใบสั่งซื้อ</h3>
                                          ...
                                          <div class=\"btn-group\">
                                              ...
                                              <ul class=\"dropdown-menu\" role=\"menu\">
                                                  <li><a href=\"com_history_document_approval.php\"><i class=\"fa
                                                              fa-share\"></i>
                                                          ประวัติการพิมพ์ใบขอซื้อ/ใบสั่งซื้อทั้งหมด</a></li>
                                              </ul>
                                          </div>
                                      </div>
