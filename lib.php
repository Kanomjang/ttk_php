...
$passwd='object';
$database='ttk_php';
$homepage="http://www.ttk_phpschool.ccs2.go.th/main/index1.php";
$www_home="http://www.ttk_phpschool.ccs2.go.th/main/index1.php";
#$eof_home="http://www.ttk_php.ac.th/mcp_applications/e-office";
...
$query = mysqli_db_query($connect,$sql_query);
...
$count_pic = mysqli_num_rows($query2);
...
$shows=mysqli_query($connect,$sql_query);;
$count_id_position=mysqli_num_rows($shows);
...
$sql_query="select id_position from position_emp where id_position>'3'and id_emp='$id_emp' and id_side > 0 and year = '$time_year'";
$shows=mysqli_query($connect,$sql_query);;
$count_id_position_more=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_dept_id_position=mysqli_num_rows($shows);
...
$sql_query="select id_position from position_emp where id_position>'3'and id_emp='$id_emp' and id_dept > 0 and year = '$time_year'";
$shows=mysqli_query($connect,$sql_query);;
$count_dept_id_position_more=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_plot_edu_duty=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_calendar_title=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_id_news=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_subject_title_emp=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_el_name_subject=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_emp_in_post_news=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_emp_post_news=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_name_group_news=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_informed=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_plot_edu_tracking=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_plot_edu_total_tracking=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_plot_duty=mysqli_num_rows($shows);
...
$shows=mysqli_query($connect,$sql_query);;
$count_id_emp=mysqli_num_rows($shows);
