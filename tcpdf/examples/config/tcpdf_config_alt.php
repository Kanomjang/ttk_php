 ...
 * Header title.
 */
//$string=iconv('UTF-8','cp874',"โรงเรียนวัดท่าเกวียน(สัยอุทิศ)");
define ('PDF_HEADER_TITLE', "โรงเรียนวัดท่าเกวียน(สัยอุทิศ)");

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Wattakwian (Sai-Utit) School");
